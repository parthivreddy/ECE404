...
def encryption(plainText, keyWords, subTable): #implements AES encryption
    AES_modulus = BitVector(bitstring='100011011')

    #Modify taking in plainTextFile and outfile as arguments
    BLOCKSIZE = 128 #128 bit block

    plaintext_bv = plainText
    ...
    for i in range(numBlocks): #do for each 128 bit block
        ...
        for j in range(14): #14 rounds of processing for 256 bit key
            ...
            if j != 13: #if not last round of encryption mix columns
